...
export default function About() {
  return (
    <div className="bg-image">
      ...
      <h3>What We Offer</h3>   
      <p><strong>Wide Selection:</strong> From boutique hotels to international chains, we offer a diverse range of options to suit every 
        traveler's needs.<br/>
        <strong>Best Price Guarantee:</strong> We are committed to providing you with the best rates available. If you find a lower price 
        elsewhere, we'll match it.<br/>
        <strong>24/7 Customer Support:</strong> Our dedicated customer service team is available around the clock to assist you with your 
        booking and answer any questions you may have.<br/>
        <strong>User-Friendly Experience:</strong> Our website is designed to be intuitive and easy to use, allowing you to book your stay 
        quickly and efficiently.</p> 

      <h3>Why Choose Us?</h3>
      <p><strong>Trusted by Millions:</strong> We have helped millions of travelers find their perfect stay, and our satisfied customers 
        speak to our reliability and quality of service.<br/>
        <strong>Secure Booking:</strong> Your safety is our priority. Our secure booking process ensures that your personal information is 
        protected at all times.<br/>
        <strong>Travel Tips and Guides:</strong> Our blog and travel guides offer valuable insights and tips to help you make the most of 
        your trip. </p> 
      ...
      <p>Have questions or need assistance? Feel free to reach out to us:<br/>
         ...
         Thank you for choosing LuxuryStay. We look forward to helping you find your perfect stay! </p> 
    </div>
    <div className="spacer"></div>
  </div> 
